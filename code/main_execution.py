# Mid-project orchestration script.
# Runs the full flow end-to-end: data prep, baseline, TRABSA training, and plots.
...
CONFIG = {
    'dataset_path': os.getenv('DATA_CSV', 'mental_health_dataset.csv'),
