"""Data preparation utilities for the mid-review prototype.

This module keeps the pipeline straightforward and reproducible:
- load CSV data
- clean and normalize text
- tokenize with RoBERTa
- create stratified train/val/test loaders
"""
...
# Current dataset label map (7 classes) used throughout training/evaluation.
